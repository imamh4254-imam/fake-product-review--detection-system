...
Build an intelligent text classification model
Provide a simple and user-friendly dashboard interface
...
Model predicts whether it is Fake or Genuine
*Visualization
Display results using dashboard (Power BI / Streamlit)
...
Helps users make better purchasing decisions.
